...
class PopNTests(unittest.TestCase):
    """Exercise literal and where-derived pop counts through every stage."""
    ...
    def test_literal_count_executes_and_round_trips(self):
        ...
        self.assertIn(Instruction(OpCode.POP_N, 3), program.main.instructions)
    ...
    def test_where_count_can_depend_on_function_arity(self):
        ...
        1 2 fn (:Number) => double end
        fn (:Number, :Number) => + end cleanup
        """
    ...
    def test_runtime_variable_is_rejected(self):
        analyser, _typed = self.analyse("1 2 pop_n($count)")
    ...
    def test_dedicated_optimization_combines_adjacent_pops(self):
        ...
        self.assertEqual(
            ...
            (Instruction(OpCode.POP_N, 4), Instruction(OpCode.RETURN)),
        )
