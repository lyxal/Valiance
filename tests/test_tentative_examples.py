...
evaluate("3 4 +")
'''
        self.assertEqual(execute(source), [Decimal("7")])
...
[1, 2, 3] otherSquares
'''
        self.assertEqual(execute(source), [Decimal("14"), Decimal("14")])
...
'''
        self.assertEqual(execute(source), [Decimal("0.375")])
...
'''
        self.assertEqual(
            execute(source),
            [Decimal("21"), Decimal("21"), Decimal("21")],
        )
...
1 2 3 $dip(fn => +)
'''
        self.assertEqual(execute(source), [Decimal("3"), Decimal("3")])
...
'''
        self.assertEqual(execute(source), [Decimal("2"), Decimal("1")])
